...
export const discoverGroups = [
  {
    ...
    iconKey: "waves",
    blurb: "Sunrise shell walks, pickup volleyball on the south end, and bonfire meetups when permits allow.",
    filterTags: ["Nature & Outdoors", "Travel"],
    coverDefault: lf("beach,sunrise", "g-hike-ga", "default"),
    coverByFilter: {
      "Nature & Outdoors": lf("ocean,waves", "g-hike-ga", chipSlug("Nature & Outdoors")),
      Travel: lf("boardwalk,beach", "g-hike-ga", chipSlug("Travel")),
    },
    nameByFilter: {
      "Nature & Outdoors": "Low Tide Walks & Dune Care Days",
      Travel: "Day Trips from Downtown to Tybee",
    },
    since: "July 2021",
    activityShort: "8+ posts a day",
  },
  {
    id: "g-wild-women",
    outdoorsHeavy: true,
  ...
  },
  {
    id: "g-north-ga",
    outdoorsHeavy: true,
    name: "Ossabaw Island Stewardship Volunteers",
    category: "Conservation · Coastal GA",
    memberCount: "740 members",
    iconKey: "compass",
    blurb: "Weekend workdays for beach cleanups, sea turtle patrol briefings, and research-site tours — ferry carpool notes in the pinned post.",
    filterTags: ["Nature & Outdoors", "Education"],
    coverDefault: lf("island,shore", "g-north-ga", "default"),
    coverByFilter: {
      "Nature & Outdoors": lf("beach,cleanup", "g-north-ga", chipSlug("Nature & Outdoors")),
      Education: lf("laboratory,science", "g-north-ga", chipSlug("Education")),
    },
    nameByFilter: {
      "Nature & Outdoors": "Island Habitat & Shorebird Protection",
      Education: "Research Walks & Junior Naturalists",
    },
    activityShort: "Weekly signup posts",
  },
  {
    id: "g-ga-outdoor",
    outdoorsHeavy: true,
